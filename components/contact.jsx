...
const Contact = () => {
    ...
    return (
        ...
        <section className="z-10 bg-primary text-gray-100 px-8 pb-12">
            <div className="z-10 text-center w-full">
                <svg className="z-10 text-gray-100 h-8 mx-auto" fill="none" viewBox="0 0 150 29" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="Desktop-HD" transform="translate(-1112.000000, -438.000000)" fill="none">
            ...
            <div
                ...
                <div className="z-10 flex flex-col justify-between">
                    ...
                    <div className="z-10 mt-8 text-center">
                        <svg className="z-10 w-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                            ...
                            <g opacity="0.1">
                                ...
                                <path
                                    ...
                                    transform="translate(-52 -162.63)" fill="#2E90E1" />
                                <path
                            ...
                            <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#2E90E1" opacity="0.1" />
                            <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#2E90E1" opacity="0.1" />
                            <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#2E90E1" opacity="0.1" />
                            <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#2E90E1" opacity="0.1" />
                            <path
                                ...
                                transform="translate(-52 -162.63)" fill="#2E90E1" opacity="0.1" />
                            <path
