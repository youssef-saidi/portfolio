            ...
            <div className="z-10 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="z-10 relative flex h-16 items-center justify-between">
                    ...
                    <div className="z-10 absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <a href="https://www.facebook.com/youssefsaidi869/" target={"_blank"}>
                        ...
                        <a href="mailto:youssefsaidi869@gmail.com" target={"_blank"}>
                        ...
                        <a href="https://www.linkedin.com/in/saidi-youssef-0431671a5" target={"_blank"}>
                        ...
                        <a target={"_blank"} href="https://web.whatsapp.com/send?phone=+21694355732">
