            ...
            <div className="z-10 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="z-10 relative flex h-16 items-center justify-between">
                        ...
                        <div className="z-10 hidden sm:ml-16 sm:block">
                            <ul className="z-10 flex space-x-8 list-none">
                                <li className={router.asPath == "/" ? "active" : "text-black "}>
                                    <a href="/" className="z-10 py-2 lg:text-lg text-sm font-semibold tracking-wider" aria-current="page">Portfolio</a>
                                </li>
                                <li className={router.asPath == "/#services" ? "active" : "text-black "}>
                                    <a href="/#services" className="z-10 py-2 lg:text-lg text-sm font-semibold tracking-wider">Services</a>
                                </li>
                                <li className={router.asPath == "/#skills" ? "active" : "text-black "}>
                                    <a href="/#skills" className="z-10 py-2 lg:text-lg text-sm font-semibold tracking-wider">Skills</a>
                                </li>
                                <li className={router.asPath == "/#projects" ? "active" : "text-black "}>
                                    <a href="/#projects" className="z-10 py-2 lg:text-lg text-sm font-semibold tracking-wider">Projects</a>
                                </li>
                                <li className={router.asPath == "/#contact" ? "active" : "text-black "}>
                                    <a href="/#contact" className="z-10 py-2 lg:text-lg text-sm font-semibold tracking-wider">Contact</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="z-10 absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        {/* ----------Icons---------- */}
                        <a href="https://www.facebook.com/youssefsaidi869/">
                        ...
                        <a href="mailto:youssefsaidi869@gmail.com">
                        ...
                        <a href="https://www.linkedin.com/in/saidi-youssef-0431671a5">
                        ...
                        <a href="https://web.whatsapp.com/send?phone=+21694355732">
            ...
            {openNav &&
                <div className="z-10 sm:hidden absolute bg-white w-screen shadow-lg pl-3">
                    <ul className="z-10 space-y-1 px-2 pt-2 pb-3 list-none">
                        <li className={router.asPath == "/" ? "active" : "text-black"}> <a href="/" className="z-10 block  py-2 text-base font-semibold tracking-wider" aria-current="page">Portfolio</a></li>

                        <li className={router.asPath == "/#services" ? "active" : "text-black"}> <a href="/#services" className="z-10 block  py-2 text-base font-semibold tracking-wider">Services</a></li>

                        <li className={router.asPath == "/skills" ? "active" : "text-black"}> <a href="/skills" className="z-10 block  py-2 text-base font-semibold tracking-wider">Skills</a></li>

                        <li className={router.asPath == "/projects" ? "active" : "text-black"}> <a href="/projects" className="z-10 block  py-2 text-base font-semibold tracking-wider">Projects</a></li>

                        <li className={router.asPath == "/contact" ? "active" : "text-black"}> <a href="/contact" className="z-10 block  py-2 text-base font-semibold tracking-wider">Contact</a></li>
                    </ul>
                </div>}
        </nav>
    )
