            ...
            <div className="z-10 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="z-10 relative flex h-16 items-center justify-between">
                    ...
                    <div className="z-10 absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <a href="https://www.facebook.com/youssefsaidi869/" target={"_blank"} rel="noreferrer">
                            <svg className='mx-2  hover:fill-blue-500 hover:scale-125 cursor-pointer' width="25" height="25" viewBox="0 0 47 47" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="" target={"_blank"} rel="noreferrer">
                            <svg className='mx-2 hover:fill-indigo-700 hover:scale-125 cursor-pointer' width="20" height="20" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="mailto:youssefsaidi869@gmail.com" target={"_blank"} rel="noreferrer">
                            <svg className='mx-2 hover:fill-red-500 hover:scale-125 cursor-pointer' width="25" height="35" viewBox="0 0 47 47" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.linkedin.com/in/saidi-youssef-0431671a5" target={"_blank"} rel="noreferrer">
                            <svg className='mx-2 hover:fill-blue-700 hover:scale-125 cursor-pointer' width="20" height="20" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a target={"_blank"} href="https://web.whatsapp.com/send?phone=+21694355732" rel="noreferrer">
                            <svg className='mx-2 hover:fill-green-500 hover:scale-125 cursor-pointer' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="27" height="27" viewBox="0 0 30 30">
